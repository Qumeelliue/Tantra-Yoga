...
# Для Tantra: The Game это: готовый образец, как Telegram-бот «открывает» мини-апп —
...
# Использовать как референс при написании бота-обёртки Tantra: The Game. Копировать
